...
import CommercialTwo from '../assets/CommercialTwo.jpeg';  // Ensure the path is correct

const CommercialProductTwo = () => {
    const navigate = useNavigate();
    const [value, setValue] = useState(4.5); // Default rating value
                ...
                <Grid container spacing={4} sx={{ mb: 4 }}>
                    <Grid item xs={12} md={5}>
                        <Card>
                            <CardMedia
                                component="img"
                                image={CommercialTwo} // Ensure this image is correct
                                alt="DT-500 AUTO"
                                sx={{ 
                                    height: 300,
                                    objectFit: 'cover',
