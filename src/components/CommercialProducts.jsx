...
const CommercialProducts = () => {
  ...
  const breadcrumbs = [
    ...
    <Typography key="commercial-products">
          ...
          <Container maxWidth="xl" sx={{ mb: 8, py: 6 }}>
            ...
            >
              <Box sx={{ flex: 1.5, width: "100%" }}>
                ...
                <Typography
                  variant="body1"
                  sx={{ fontSize: "1.1rem", lineHeight: 1.8, color: "black" }}
                >
                  At <b>Durga Traders</b>, we provide cutting-edge commercial
                  water systems designed to meet the highest standards of
                  purity, performance, and reliability. Whether you're a
                  business, factory, hotel, or healthcare center, our water
                  solutions ensure your team and customers enjoy clean, safe,
                  and great-tasting water every single time.
                </Typography>
              </Box>
              <Box
                sx={{
                  ...
                  >
                    ...
                    <Button
                      ...
                      sx={{
                        ...
                        py: 1.5,
                        background:
                          "linear-gradient(90deg, #022279 0%, #00C7E8 100%)",
                        "&:hover": {
                          background:
                            "linear-gradient(90deg, #021a5c 0%, #00a5c7 100%)", // slightly darker gradient on hover
                        },
                        borderRadius: "8px",
                        fontWeight: "bold",
                        color: "#fff",
              ...
              >
                <CardContent sx={{ p: 3 }}>
                  ...
                  <Typography variant="body2" color="text.secondary">
                    ✅ Advanced Reverse Osmosis systems designed for high-volume
                    usage and consistent output. Ideal for industries,
                    restaurants, and large institutions.
                  </Typography>
                </CardContent>
              </Card>
            </Grid>
            ...
            >
              ...
              >
                <CardContent sx={{ p: 3 }}>
                  ...
                  <Typography variant="body2" color="text.secondary">
                    ✅ Remove harmful contaminants and deliver crystal-clear
                    water with energy-efficient purification systems built for
                    continuous use.
                  </Typography>
                </CardContent>
              </Card>
            ...
            >
              ...
              >
                <CardContent sx={{ p: 3 }}>
                  ...
                  <Typography variant="body2" color="text.secondary">
                    ✅ Smart temperature control, sleek designs, and hygienic
                    dispensing for corporate offices, schools, and public
                    facilities.
                  </Typography>
                </CardContent>
              </Card>
            ...
            >
              ...
              >
                <CardContent sx={{ p: 3 }}>
                  ...
                  <Typography variant="body2" color="text.secondary">
                    ✅ Reduce hardness, protect your appliances, and increase
            ...
            >
              ...
              >
                <CardContent sx={{ p: 3 }}>
                  ...
                  <Typography variant="body2" color="text.secondary">
                    ✅ Chemical-free purification with advanced UV/UF
                    technology, suitable for hospitals and food processing
                    units.
                  </Typography>
                </CardContent>
              </Card>
        ...
        >
          ...
          >
            ...
            <Button
              ...
              onClick={() => {
                if (isTamilNaduPincode(pincode)) {
                  ...
                  setResultType("error");
                  setResultMessage(
                    "🚫 Sorry, our service is not yet available in your area."
                  );
                }
              }}
              sx={{
            ...
            >
              ...
              <Typography
                variant="body1"
                sx={{ fontSize: "0.95rem", color: "black" }}
              >
                We collect your PIN code to connect you with the nearest
                available suppliers and ensure faster service in your region.
              </Typography>
            </Box>
            ...
            {resultMessage && (
              <Typography
                sx={{
                  ...
                  p: 2,
                  backgroundColor:
                    resultType === "success" ? "#e8f5e9" : "#ffebee",
                  borderRadius: "8px",
                  fontSize: "1rem", // Fixed font size
                }}
              >
